  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless tool rental with Construction Tool Rental v1 - Your one-stop solution for renting construction tools from multiple outlets."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless tool rental with Construction Tool Rental v1 - Your one-stop solution for renting construction tools from multiple outlets.`}
            </Text>
            <Box
